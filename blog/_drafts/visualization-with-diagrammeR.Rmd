...
Have you ever needed to create a visualization of a research process or statistical model that isn't directly plotted from data?  The R package [DiagrammeR](http://rich-iannone.github.io/DiagrammeR/index.html) makes it much easier to create high quality figures and diagrams in situations like these.  
...
A more complex diagram, specifying difference colors for some nodes, and using subgraph clustering.  
```{r}
...
It's also pretty easy to create diagrams in mermaid, but it seems slightly less customizable.  
