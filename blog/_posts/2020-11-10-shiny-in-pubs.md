...
[^7]: Zenodo mints both a specific version DOI and a "concept" DOI that will always link to the lastest release of a GitHub repository. Learn more about versioning DOIs on [Zenodo's FAQ page](https://help.zenodo.org/#versioning)
[^8]: How to [Share apps](https://shiny.rstudio.com/tutorial/written-tutorial/lesson7/)
[^9]: Read more about publishing datasets in our Quickstart guide [here](https://cyberhelp.sesync.org/quickstart/sharing-data-products.html)
