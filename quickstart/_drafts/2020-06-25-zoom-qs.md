...
![Zoom Decision Tree](/assets/images/Zoom_Decision_Tree.png)
...
1. We are unlikely to be able to handle support requests outside of 8am-6pm Monday-Friday Eastern Time (UTC-5 until 14 March 2021).
2. We request that group’s have their final meeting times and dates confirmed at least two weeks prior to the meeting.  
3. Due to restrictions on UMD’s Zoom licenses, if SESYNC sets up a Zoom call for your group we will be unable to make you host or co-host ahead of time. However, we can transfer host or co-host responsibilities as soon as the meeting starts.
